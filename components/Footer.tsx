  ...
  return (
    <footer className="bg-slate-100 dark:bg-slate-800/50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 text-center text-slate-500 dark:text-slate-400">
        <div className="flex justify-center space-x-6 mb-4">
          {PERSONAL_INFO.linkedin && (
            <a 
              ...
              className="p-1 rounded-full hover:text-sky-600 dark:hover:text-sky-400 transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-100 dark:focus-visible:ring-offset-slate-800" 
              aria-label={`${PERSONAL_INFO.name}'s LinkedIn Profile`}
            >
          ...
          {PERSONAL_INFO.github && (
            <a 
              ...
              rel="noopener noreferrer" 
              className="p-1 rounded-full hover:text-sky-600 dark:hover:text-sky-400 transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-100 dark:focus-visible:ring-offset-slate-800"
              aria-label={`${PERSONAL_INFO.name}'s GitHub Profile`}
            >
        ...
        <p className="text-sm">&copy; {new Date().getFullYear()} {PERSONAL_INFO.name}. All Rights Reserved.</p>
      </div>
    </footer>
  );
};
